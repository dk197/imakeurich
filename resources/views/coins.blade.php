                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            <div class="col-sm-12 text-center">
                                    <a id="watchAdBtn" class="btn btn-primary btn-block coinChanger" >Get 1 Free Coin</a>
                            </div>
                        </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-header text-center">Buy</div>
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <a id="buy99" class="btn btn-primary btn-block coinChanger">Buy Now for 0,99€</a>
                                </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header text-center">Buy</div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 text-center">
                                        <a id="buy999" class="btn btn-primary btn-block coinChanger">Buy Now for 9,99€</a>
                                    </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header text-center">Buy</div>
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 text-center">
                                            <a id="buy9999" class="btn btn-primary btn-block coinChanger">Buy Now for 99,99€</a>
                                        </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-12 mt-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                                <div class="col-sm-12 text-center">
                                        <a id="donate10" class="btn btn-primary btn-block coinChanger">Donate 10 Coins</a>
                                </div>
                            </div>
                    </div>
                </div>
