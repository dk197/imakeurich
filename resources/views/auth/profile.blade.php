...
<div class="container">
    <div class="jumbotron p-4 p-md-5 text-white rounded bg-dark">
      ...
      <h1 class="display-4 font-italic">Hey {{Auth::user()->username}},</h1>
        <p class="lead my-3">here you can see all of your personal statistics:</p>
      </div>
    </div>
      ...
      <div class="col-md-6">
        <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <strong class="d-inline-block mb-2 text-primary">Why are U so damn rich?</strong>
            <h3 class="mb-0">You are rich since</h3>
